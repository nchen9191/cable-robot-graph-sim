...
from model_predictive_control.mppi_utils import generate_gaussian_halton_samples, scale_ctrl, cost_to_go
...
class MPPIPlanner(ABC):
    ...
    def __init__(self,
        ...
        self.tensor_args = {'device': cfg.device, 'dtype': cfg.dtype}
        self.delta = None
        ...
        if not cfg.noise_sigma:
            cfg.noise_sigma = np.identity(cfg.nu).tolist()
    ...
    def get_samples(self, sample_shape, **kwargs):
        ...
        if (self.sample_method == 'halton'):
            ...
            knot_samples = self.knot_points.view(sample_shape, self.nu,
                                                 self.n_knots)  # n knots is T/knot_scale (30/4 = 7)
    ...
    def command(self, state):
        ...
        if self.mppi_mode == 'simple':
            ...
            cost_total, actions = self._compute_total_cost_batch_simple()
    ...
    def _compute_total_cost_batch_simple(self):
        ...
        return self.cost_total, self.actions
